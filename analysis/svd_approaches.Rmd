...
```{r, fig.width = 4, fig.asp = 1}
plot_reconstruct_fun(svd1_49, transpose = FALSE, "children_comb_char") +
...
```{r, fig.width = 3, fig.asp = 1}
plot_U_fun(svd1_49, "children_comb_char", transpose = FALSE, multiply = FALSE) +
  labs(title = "SVD: Children, 4-9y (Approach #1)",
       subtitle = "U: Feature vectors (by mode)",
       # subtitle = "U x S: Feature vectors multiplied by singular value (by mode)",
       x = "", y = "") +
...
```{r, fig.width = 3, fig.asp = 1}
plot_V_fun(svd1_49, "children_comb_char", transpose = FALSE, multiply = FALSE) +
  labs(title = "SVD: Children, 4-9y (Approach #1)",
       subtitle = "V: Item vectors (by mode)",
       # subtitle = "V x S: Item vectors multiplied by singular value (by mode)",
       x = "", y = "")
...
```{r, fig.width = 4, fig.asp = 1}
plot_V_fun_item(svd1_49, "children_comb_char", efa_colors = TRUE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 4-9y (Approach #1)",
       subtitle = "V: Capacities in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
temp_rect <- U_fun(svd1_49, "children_comb_char") %>%
...
```{r, fig.width = 4, fig.asp = 1}
plot_reconstruct_fun(svd2_49, transpose = TRUE, "children_comb_char") +
...
```{r, fig.width = 3, fig.asp = 1}
plot_U_fun(svd2_49, "children_comb_char", transpose = TRUE, multiply = FALSE) +
  labs(title = "SVD: Children, 4-9y (Approach #2)",
       subtitle = "U: Feature vectors (by mode)",
       # subtitle = "U x S: Feature vectors multiplied by singular value (by mode)",
       x = "", y = "")
...
```{r, fig.width = 3, fig.asp = 1}
plot_V_fun(svd2_49, "children_comb_char", transpose = TRUE, multiply = FALSE) +
  labs(title = "SVD: Children, 4-9y (Approach #2)",
       subtitle = "V: Item vectors (by mode)",
       # subtitle = "V x S: Item vectors multiplied by singular value (by mode)",
       x = "", y = "") +
...
```{r, fig.width = 4, fig.asp = 1}
temp_rect <- V_fun(svd2_49, "children_comb_char", transpose = TRUE) %>%
...
V_fun(svd2_49, "children_comb_char", transpose = TRUE) %>%
  mutate(age_group = ifelse(grepl("79", item), "7-9y",
                            ifelse(grepl("46", item), "4-6y", NA)),
         item = gsub("_..$", "", item)) %>%
  spread(mode, value) %>%
  ggplot(aes(x = mode_01, y = mode_02, label = item, color = age_group)) +
  geom_rect(data = temp_rect,
            aes(x = NULL, y = NULL, label = NULL,
                xmin = min_01, xmax = max_01, ymin = min_02, ymax = max_02,
                color = age_group, fill = age_group, group = age_group), 
  ...
  ggrepel::geom_text_repel(show.legend = F, size = 3) +
  theme_minimal() +
  labs(title = "SVD: Children, 4-9y (Approach #2, Comb. Method #1)",
       subtitle = "V: Characters in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2", color = "Age Group", fill = "Age Group")
...
V_fun(svd2_49, "children_comb_char", transpose = TRUE) %>%
  mutate(age_group = ifelse(grepl("79", item), "7-9y",
         ...
         item = gsub("_..$", "", item)) %>%
  spread(mode, value) %>%
  ggplot(aes(x = mode_01, y = mode_03, label = item, color = age_group)) +
  geom_rect(data = temp_rect,
            aes(x = NULL, y = NULL, label = NULL,
                xmin = min_01, xmax = max_01, ymin = min_03, ymax = max_03,
                color = age_group, fill = age_group, group = age_group), 
...
V_fun(svd2_49, "children_comb_char", transpose = TRUE) %>%
  mutate(age_group = ifelse(grepl("79", item), "7-9y",
         ...
         item = gsub("_..$", "", item)) %>%
  spread(mode, value) %>%
  ggplot(aes(x = mode_02, y = mode_03, label = item, color = age_group)) +
  geom_rect(data = temp_rect,
            aes(x = NULL, y = NULL, label = NULL,
                xmin = min_02, xmax = max_02, ymin = min_03, ymax = max_03,
                color = age_group, fill = age_group, group = age_group), 
...
```{r, fig.width = 4, fig.asp = 1}
plot_U_fun_prop(svd2_49, "children_comb_char", transpose = TRUE, efa_colors = TRUE,
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 4-9y (Approach #2)",
       subtitle = "U: Capacities in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
...
svd3_49 <- svd(d_79 %>%
                 ...
                 mutate(character = factor(character,
                                           levels = c(paste0(levels(d_79$character), 
                                                             "_79"),
                                                      paste0(levels(d_79$character),
                                                             "_46")))) %>%
                 arrange(character) %>%
                 column_to_rownames("character"), 
               nrow(d_79) + nrow(d_46), nrow(d_79) + nrow(d_46))
...
```{r, fig.width = 4, fig.asp = 1}
plot_reconstruct_fun(svd3_49, transpose = FALSE, "children_comb_char") +
...
```{r, fig.width = 3, fig.asp = 1}
plot_U_fun(svd3_49, "children_comb_char", transpose = FALSE, multiply = FALSE) +
  labs(title = "SVD: Children, 4-9y (Approach #3)",
       subtitle = "U: Feature vectors (by mode)",
       # subtitle = "U x S: Feature vectors multiplied by singular value (by mode)",
       x = "", y = "") +
...
```{r, fig.width = 3, fig.asp = 1}
plot_V_fun(svd3_49, "children_comb_char", transpose = FALSE, multiply = FALSE) +
  labs(title = "SVD: Children, 4-9y (Approach #3)",
       subtitle = "V: Item vectors (by mode)",
       # subtitle = "V x S: Item vectors multiplied by singular value (by mode)",
       x = "", y = "")
...
```{r, fig.width = 4, fig.asp = 1}
plot_V_fun_item(svd3_49, "children_comb_char", efa_colors = TRUE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 4-9y (Approach #3)",
       subtitle = "V: Capacities in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
temp_rect <- U_fun(svd3_49, "children_comb_char") %>%
  mutate(age_group = ifelse(grepl("79", property), "7-9y",
                            ifelse(grepl("46", property), "4-6y", NA)),
         property = gsub("_..$", "", property)) %>%
  spread(mode, value) %>%
...
U_fun(svd3_49, "children_comb_char") %>%
  mutate(age_group = ifelse(grepl("79", property), "7-9y",
                            ifelse(grepl("46", property), "4-6y", NA)),
         property = gsub("_..$", "", property)) %>%
  spread(mode, value) %>%
  ...
  ggrepel::geom_text_repel(show.legend = F, size = 3) +
  theme_minimal() +
  labs(title = "SVD: Children, 4-9y (Approach #3, Comb. Method #1)",
       subtitle = "U: Characters in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2", color = "Age Group", fill = "Age Group")
...
svd4_49 <- svd(d_79 %>%
                 ...
                 mean_cent_fun("character", age_group = "children") %>%
                 column_to_rownames("capacity") %>%
                 select(computer_79, robot_79, doll_79, teddy_bear_79, 
                        beetle_79, bird_79, mouse_79, goat_79, elephant_79,
                        computer_46, robot_46, doll_46, teddy_bear_46, 
                        beetle_46, bird_46, mouse_46, goat_46, elephant_46), 
               nrow(d_79) + nrow(d_46), nrow(d_79) + nrow(d_46))
```
...
```{r, fig.width = 4, fig.asp = 1}
plot_reconstruct_fun(svd4_49, "children_comb_char", transpose = TRUE) +
...
```{r, fig.width = 3, fig.asp = 1}
plot_U_fun(svd4_49, "children_comb_char", transpose = TRUE, multiply = FALSE) +
  labs(title = "SVD: Children, 4-9y (Approach #4)",
       subtitle = "U: Feature vectors (by mode)",
       # subtitle = "U x S: Feature vectors multiplied by singular value (by mode)",
       x = "", y = "")
...
```{r, fig.width = 3, fig.asp = 1}
plot_V_fun(svd4_49, "children_comb_char", transpose = TRUE, multiply = FALSE) +
  labs(title = "SVD: Children, 4-9y (Approach #4)",
       subtitle = "V: Item vectors (by mode)",
       # subtitle = "V x S: Item vectors multiplied by singular value (by mode)",
       x = "", y = "") +
...
```{r, fig.width = 4, fig.asp = 1}
temp_rect <- V_fun(svd4_49, "children_comb_char", transpose = TRUE) %>%
  mutate(age_group = ifelse(grepl("79", item), "7-9y",
                            ifelse(grepl("46", item), "4-6y", NA)),
         item = gsub("_..$", "", item)) %>%
  spread(mode, value) %>%
...
V_fun(svd4_49, "children_comb_char", transpose = TRUE) %>%
  mutate(age_group = ifelse(grepl("79", item), "7-9y",
                            ifelse(grepl("46", item), "4-6y", NA)),
         item = gsub("_..$", "", item)) %>%
  spread(mode, value) %>%
  ...
  ggrepel::geom_text_repel(show.legend = F, size = 3) +
  theme_minimal() +
  labs(title = "SVD: Children, 4-9y (Approach #4, Comb. Method #1)",
       subtitle = "V: Characters in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2", color = "Age Group", fill = "Age Group")
...
```{r, fig.width = 4, fig.asp = 1}
plot_U_fun_prop(svd4_49, "children_comb_char", transpose = TRUE, efa_colors = TRUE,
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 4-9y (Approach #4)",
       subtitle = "U: Capacities in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
