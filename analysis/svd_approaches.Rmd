...
plot_U_fun_prop <- function(svd, 
  ...
  if(efa_colors == TRUE){
    ...
    plot <- plot + scale_color_manual(values = "black")
  }
...
```{r, fig.width = 3, fig.asp = 1.49, include = F}
...
```{r, fig.width = 4, fig.asp = 1}
plot_V_fun_item(svd3_ad, "adults", FALSE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Adults (Approach #3)",
       subtitle = "V: Capacities in Modes 1 & 2", 
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_U_fun_prop(svd3_ad, "adults", FALSE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Adults (Approach #3)",
       subtitle = "U: Characters in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_V_fun_item(svd3_79, "children", FALSE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 7-9y (Approach #3)",
       subtitle = "V: Capacities in Modes 1 & 2", 
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_U_fun_prop(svd3_79, "children", FALSE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 7-9y (Approach #3)",
       subtitle = "U: Characters in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_V_fun_item(svd3_46, "children", FALSE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 4-6y (Approach #3)",
       subtitle = "V: Capacities in Modes 1 & 2", 
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_U_fun_prop(svd3_46, "children", FALSE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 4-6y (Approach #3)",
       subtitle = "U: Characters in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_V_fun_item(svd4_ad, "adults", TRUE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Adults (Approach #4)",
       subtitle = "V: Characters in Modes 1 & 2", 
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_U_fun_prop(svd4_ad, "adults", TRUE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Adults (Approach #4)",
       subtitle = "U: Capacities in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_V_fun_item(svd4_79, "children", TRUE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 7-9y (Approach #4)",
       subtitle = "V: Characters in Modes 1 & 2", 
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_U_fun_prop(svd4_79, "children", TRUE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 7-9y (Approach #4)",
       subtitle = "U: Capacities in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_V_fun_item(svd4_46, "children", TRUE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 4-6y (Approach #4)",
       subtitle = "V: Characters in Modes 1 & 2", 
       x = "Mode 1", y = "Mode 2")
...
```{r, fig.width = 4, fig.asp = 1}
plot_U_fun_prop(svd4_46, "children", TRUE, FALSE, 
                modes = c("mode_01", "mode_02")) +
  labs(title = "SVD: Children, 4-6y (Approach #4)",
       subtitle = "U: Capacities in Modes 1 & 2",
       x = "Mode 1", y = "Mode 2")
